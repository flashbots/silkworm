...
StageResult stage_senders(db::TransactionManager& txn, const std::filesystem::path& etl_path, uint64_t) {
...
StageResult unwind_senders(db::TransactionManager& txn, const std::filesystem::path&, uint64_t unwind_point) {
...
StageResult prune_senders(db::TransactionManager& txn, const std::filesystem::path&, uint64_t prune_from) {
